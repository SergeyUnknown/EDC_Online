...
namespace EDC
{
    public class DownTableDataItem
    {
        ...
        public DownTableDataItem(string buttonText,
            ...
            string buttonImageURL = "~/Images/table-row-plus-after.png")
        {
            ...
            _pageInfo = string.Format(Resources.LocalizedText.Page_of_, currentPageIndex, maxPageIndex);
            _buttonImageURL = buttonImageURL;
        }
